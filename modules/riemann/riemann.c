...
_insert_batch(RiemannDestWorker *self, LogMessage *msg)
{
  ...
  if (owner->super.flush_lines > 1 && self->super.batch_size >= owner->super.flush_lines)
    {
      return log_threaded_dest_worker_flush(&self->super);
    }
